...
import { categoryDisplayLabel } from '../utils/catalog';
...
const SearchResultsView = ({
    ...
    const displayTitle = query ? query : (activeCategory === "All" || !activeCategory ? "Catalogue" : categoryDisplayLabel(activeCategory));
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="px-3 py-1 bg-blue-600 text-white rounded-full text-[8px] font-black uppercase tracking-widest animate-pulse">
                                {query ? 'Recherche en direct' : 'Catalogue selection'}
                            </div>
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">Moteur de recherche v2.0</span>
                        </div>
