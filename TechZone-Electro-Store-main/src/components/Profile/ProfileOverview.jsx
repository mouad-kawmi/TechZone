            ...
            {onAdminClick && (
                ...
                >
                    ...
                    <div className="flex items-center gap-10 relative z-10">
                        ...
                        <div className="text-left space-y-2">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-black text-blue-400 uppercase tracking-[0.4em] leading-none">Acces autorise</span>
                            </div>
                            <h3 className="text-3xl font-black text-white uppercase tracking-tighter leading-none font-display">Console admin</h3>
                            <p className="text-[10px] font-black text-slate-400 group-hover:text-blue-200/60 uppercase tracking-[0.2em] transition-colors">Gestion de la boutique</p>
                        </div>
                    </div>
                    ...
                    <div className="hidden sm:flex flex-col items-end gap-3 relative z-10">
                        ...
                        <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Ouvrir la console</span>
                    </div>
                </button>
            )}
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-8 shadow-sm border border-slate-100 dark:border-slate-800 space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <h4 className="text-sm font-black uppercase tracking-tighter dark:text-white">Mes favoris</h4>
                    </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-8 shadow-sm border border-slate-100 dark:border-slate-800 space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <h4 className="text-sm font-black uppercase tracking-tighter dark:text-white">Points {storeName}</h4>
                    </div>
