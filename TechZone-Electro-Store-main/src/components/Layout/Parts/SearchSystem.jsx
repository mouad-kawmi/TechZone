...
const SearchSystem = ({ searchQuery, onSearch, onSearchSubmit, allProducts, onViewProduct }) => {
    ...
    return (
        <div className="relative hidden md:block" ref={sRef}>
            <div className="flex w-56 items-center rounded-xl border border-transparent bg-slate-100 px-4 py-2 transition-all duration-300 focus-within:border-blue-500/30 focus-within:bg-white dark:bg-white/5 dark:focus-within:bg-slate-900 lg:w-60 xl:w-56 2xl:w-80">
